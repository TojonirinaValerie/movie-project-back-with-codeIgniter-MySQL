...
class getid3_quicktime extends getid3_handler
{
	...
	public function Analyze() {
		...
		if (isset($info['video']) && ($info['mimeType'] == 'audio/mp4') && empty($info['video']['resolution_x']) && empty($info['video']['resolution_y']))  {
			unset($info['video']);
		}
				...
				case 'stsd': // Sample Table Sample Description atom
					...
					for ($i = 0; $i < $atom_structure['number_entries']; $i++) {
						...
						if (substr($atom_structure['sample_description_table'][$i]['data'],  1, 54) == 'application/octet-stream;type=com.parrot.videometadata') {
							...
							$atom_structure['sample_description_table'][$i]['parrot_frame_metadata']['mimeType']        =       substr($atom_structure['sample_description_table'][$i]['data'],  1, 55);
