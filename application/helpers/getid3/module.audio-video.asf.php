...
/*
								...
								if (!empty($imagechunkcheck)) {
									$thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['image_mime'] = image_type_to_mimeType($imagechunkcheck[2]);
								}
...
*/
						...
						switch ($streamdata['type_raw']) {
							case 1:
								if (strstr($this->TrimConvert($streamdata['name']), 'Windows Media')) {
									$thisfile_video['dataformat'] = 'wmv';
									if ($info['mimeType'] == 'video/x-ms-asf') {
										$info['mimeType'] = 'video/x-ms-wmv';
									}
								}
								break;
	...
	public function ASF_WMpicture(&$data) {
		...
		unset($imageinfo);
		if (!empty($imagechunkcheck)) {
			$WMpicture['image_mime'] = image_type_to_mimeType($imagechunkcheck[2]);
		}
