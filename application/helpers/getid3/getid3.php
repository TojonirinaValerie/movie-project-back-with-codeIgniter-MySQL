...
class getID3
{
	...
	public function analyze($filename, $filesize=null, $original_filename='', $fp=null) {
		try {
			...
			// set mime type
			$this->info['mimeType'] = $determined_format['mimeType'];
...
//						),
				...
				'matroska' => array(
							...
							'group'     => 'audio-video',
							'module'    => 'matroska',
							'mimeType' => 'video/x-matroska', // may also be audio/x-matroska
						),
	...
	public function ChannelsBitratePlaytimeCalculations() {
		...
		// Set playtime string
		if (!empty($this->info['playtime_seconds']) && empty($this->info['playtimeString'])) {
			$this->info['playtimeString'] = getid3_lib::PlaytimeString($this->info['playtime_seconds']);
		}
	}
